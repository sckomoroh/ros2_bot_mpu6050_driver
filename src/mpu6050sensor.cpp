...
{
    const double ang_vel_in_deg_per_s =
...
double MPU6050Sensor::convertRawAccelerometerData(int16_t accel_raw) const
{
    ...
    return accel_in_m_per_s * M_PI / 180.0;
}

void MPU6050Sensor::setGyroscopeOffset(double gyro_x_offset,
...
void MPU6050Sensor::setAccelerometerOffset(double accel_x_offset,
